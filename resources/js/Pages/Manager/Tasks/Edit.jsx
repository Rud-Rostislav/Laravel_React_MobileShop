...
export default function Edit(props) {
    ...
    // const [setTasks] = useState(props.setTasks);
    ...
    return (
        <>
            <form onSubmit={submit} className='project_edit_name'>
                ...
                <button type="submit" className='project_edit_name_input green task_edit_input_right_border'>Оновити задачу</button>
                ...
                <button className='project_edit_name_input red task_edit_input_left_border' onClick={() => props.setEditTask(false)}>Приховати
                    редагування
                </button>
